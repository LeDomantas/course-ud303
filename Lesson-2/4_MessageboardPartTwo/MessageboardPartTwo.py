...
class MessageHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        messageBoardForm = """<!DOCTYPE html> <title>Message Board</title> <form method="POST" action="http://localhost:8000/"> <textarea name="message"></textarea> <br> <button type="submit">Post it!</button> </form>"""
        self.wfile.write(messageBoardForm.encode())
